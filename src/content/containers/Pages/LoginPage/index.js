    ...
    return (
      <div style={{ backgroundColor: '#f2f4f7', padding: '50px' }}>
        ...
        <div className="container" style={{ maxWidth: '700px' }}>
          <div className="p-4 p-sm-5" style={{ backgroundColor: '#fff', borderWidth: '0.5px', borderColor: '#a9a9a9', borderStyle: 'solid', marginTop: '80px', borderRadius: '2%', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)' }}>
