...
class NotFoundPage extends React.PureComponent {
  render() {
    ...
    if (uniName === 'manchester-met' || uniName === 'aristotle' || uniName === 'cranfield' || uniName === 'kings' || uniName === 'loughborough' || uniName === 'oxford-brookes' ||
      uniName === 'sheffield' || uniName === 'sheffield-hallam' || uniName === 'ucl' || uniName === 'uwe' || uniName === 'durham' ||
      uniName === 'mmu' || uniName === 'liverpool-hope' || uniName === 'chester') {
      directTo = '/' + uniName;
