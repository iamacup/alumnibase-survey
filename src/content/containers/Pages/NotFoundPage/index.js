...
class NotFoundPage extends React.PureComponent {
  render() {
    ...
    if (uniName === 'aristotle' || uniName === 'cranfield' || uniName === 'kings' || uniName === 'loughborough' || uniName === 'oxford-brookes' || uniName === 'sheffield' || uniName === 'sheffield-hallam' || uniName === 'ucl' || uniName === 'uwe' || uniName === 'durham' || uniName === 'mmu') {
      directTo = '/' + uniName;
