...
// Register vendors here - this stuff only really matters whne we run the production stuff - for the live reload etc. we seem to need to have stuff required / imported directly into the files that need them
...
let devToolsSetting = isDev ? 'cheap-module-eval-source-map' : 'hidden-source-map';

// if we are on the dev environment - just use a normal source map
if (__API__ === '2' || __API__ === '"2"') {
